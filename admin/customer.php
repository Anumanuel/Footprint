			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="customer.php">Customer</a>
						</li>
					</ul>
				</div>
...
$sql = "SELECT  r_id, r_fname, r_email, r_number, r_regdate, r_status FROM registration";
...
if($result->num_rows > 0){
            while($row=$result->fetch_assoc()){
                ...
                echo '<td>' . $row["r_regdate"] . '</td>';
                if($row["r_status"]==0){
                    $status='inactive';
                    echo '<td> <a href=acstatus.php?cid='.$row['r_id'].'&&status=' .$status. '>' .$status. '</a></td>';
                }else{
                    $status='active';
                    echo '<td><a href=acstatus.php?cid='.$row['r_id'].'&&status=' .$status. '>' .$status. '</a> </td>';
                }
